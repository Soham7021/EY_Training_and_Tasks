...
def send_email_smtp(to_email, subject, body, from_email=None, app_password=None):
    """
    Sends an email via Gmail SMTP over SSL.
    Uses environment variables GMAIL_ADDRESS and GMAIL_APP_PASSWORD by default.
    Returns True on success, False on failure (prints messages to stdout).
    """
