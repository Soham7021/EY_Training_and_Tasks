...
def Researcher(state: ResearchState):
    msg = [
        SystemMessage(content="You are a research assistant. Research the given topic in detail and return 10 bullet points."),
...
def Summarizer(state: ResearchState):
    msg = [
        SystemMessage(content="You are a summarizer. Summarize the given research into a short paragraph and 5 key bullet points."),
